...
const char name[] __attribute__((address(0x848))) = "BLINK  ";
...
static Processed mnsProcessMessage(Message * m) {
    ...
    if (mode_state == MODE_SETUP) {
        switch (m->opc) {
            ...
            case OPC_RQMN:
                ...
                return PROCESSED;
            case OPC_QNN:
                sendMessage5(OPC_PNN, 0,0, MANU_MERG, MTYP_CANDEV, getParameterFlags());
                return PROCESSED;
            default:
                break;
        }
    ...
    switch (m->opc) {
        case OPC_QNN:
            sendMessage5(OPC_PNN, nn.bytes.hi,nn.bytes.lo, MANU_MERG, MTYP_CANDEV, getParameterFlags());
            return PROCESSED;
    ...
    switch (m->opc) {
        ...
        case OPC_RQSD:
            ...
            if (m->bytes[2] == 0) {
                ...
                sendMessage5(OPC_SD, nn.bytes.hi, nn.bytes.lo, 0, 0, 2);
